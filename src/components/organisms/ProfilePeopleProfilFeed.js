        ...
        <>
            ...
            <Card className="bg-card text-center mt-3">
                <Card.Body>
                    ...
                    <div class="menus">
                        <p> <Link to="/ProfilePeopleFeed" className="title-feed-a"><FontAwesomeIcon className="ms-auto me-5 icon-feed" icon={faHome} /><span className="title-feed">Feed</span></Link></p>
                        <p> <Link to="/ProfilePeopleExplore" className="title-feed-a"><FontAwesomeIcon className="ms-auto me-5 icon-explore" icon={faCompass} /><span className="title-explore">Explore</span></Link></p>
                    </div>
