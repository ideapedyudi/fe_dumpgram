        ...
        <>
            ...
            <Card className="bg-card text-center mt-3">
                ...
                <Card.Body>
                    ...
                    <div class="menu">
                        <p> <Link to="/feedpage" className="title-feed-a"><FontAwesomeIcon className="ms-auto me-5 icon-feed icon-fd" icon={faHome} /><span className="title-feed icon-fd">Feed</span></Link></p>
